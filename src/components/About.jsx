    ...
    >
      <div className="container mx-auto px-4 animate-fade-up">
        ...
        <div className="text-gray-700 dark:text-gray-300 max-w-3xl mx-auto text-center text-[17px] leading-relaxed hover:scale-[1.01] transition-transform duration-300 space-y-6">
          <p>
            I'm a Computer Science graduate with a specialization in <strong>Artificial Intelligence</strong> & <strong>Machine Learning</strong>, with hands-on experience as a <strong>Python/Django Developer</strong> at <strong>WeSalvator</strong>. I’ve worked on building real-time, scalable, and secure backend systems using modern development practices.
          </p>
          <p>
